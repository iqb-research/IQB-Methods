...
hier der Methoden-Newsletter für die letzten Monate, in dem
wir kurz Neuerungen in den R-Paketen der eat-Reihe vorstellen,
Updates zu Gruppen und Workshops geben und über sonstige
methodische Entscheidungen am Institut informieren.
...
Ein Workshop zur aktuellen Paketversion findet sich [hier](https://nickhaf.github.io/eatPlotWorkshop/#/title-slide). 
Bis zum Start der Berechnungen wird es noch einige kleinere Änderungen geben, die [Tutorials](https://nickhaf.github.io/eatPlot/index.html) werden dementsprechend aktualisiert werden. 
