...
### Labels
Tables that are build programmatically can be labeled with `#| label: tbl-judo` at the top of the chunk.
This will always put the correct number in the caption and also lets you cross-reference the table in you text by writing `@tbl-judo` @tbl-judo.  
