...
```
The model's intercept, corresponding to Region = Germany, is at `r #| echo: true model_intercept`. 
```
...
And of course, APA tables, either with [`report`](https://easystats.github.io/report/):

```{r}
report_table(model)
```

Or with [`rempsyc`](https://rempsyc.remi-theriault.com/)
