...
```{r eval = TRUE}
kbl(subset(roundDF(item,digits = 3), item == "I0006")[,c("item", "itemP", "est", "estDif", "absDif", "difIndex", "ETS")], row.names=FALSE) %>% 
    kable_styling(bootstrap_options = "striped", full_width = FALSE, position = "center")
```

Die allgemeine Lösungswahrscheinlichkeit des Items ist `r round(100*item[which(item[,"item"] == "I0006"),"itemP"], digits = 1)` Prozent. Der positive DIF-Wert bedeutet, dass das Item in der ersten Gruppe (also female = 0, die Gruppe der Jungen) schwerer ist. Die Lösungshäufigkeit sollte also für female = 0 geringer sein, als für female = 1: 
