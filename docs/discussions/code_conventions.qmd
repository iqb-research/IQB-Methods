...
1.  Klick auf `Add item`
2.  `#beckerbenj/eatGADS`
3.  Aus den Vorschlägen in der Liste kannst du das Issue auswählen, das zu zum Projekt hinzufügen möchtest, oder ein neues erstellen.\
4.  Man kann nach allen offenen Issues suchen mit `is:issue is:open`.

### Issues sortieren

- In der Spalte "Done" sind alle fertigen Issues. Sie werden ein letztes Mal im Jour fix besprochen, dann wird das Issue gemeinsam geschlossen. 
- Alles sollte ein Issue sein, kein Draft! Drafts ohne Projekt gehören in iqb-research/to-dos.
