...
To make your project truly reproducable, you might want to also use [renv](https://iqb-research.github.io/IQB-Methods/docs/r_sig/23_11_06_renv/).   
...
:::{.callout-note}
I actually prefer the [renv workflow](https://quarto.org/docs/publishing/github-pages.html#executing-code), but you have to setup [renv](https://iqb-research.github.io/IQB-Methods/docs/r_sig/23_11_06_renv/) to use it. 
:::
