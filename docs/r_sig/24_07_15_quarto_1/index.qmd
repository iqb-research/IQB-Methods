...
---
```
By using this list syntax, we can add multiple `.bib`-files to our quarto document. 
Then we only have to call the citation function in a code chunk:
