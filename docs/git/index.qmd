...
4. `Commit` them as often as possible. The more you commit, the more of you work gets saved regulary. 
...
1. Now the review process begins: The person that takes over the review assigns itself on the right side of the pull request page. 
...
7. If both are satisfied. On the GitHub Pull-request page, select "merge pull request into main" at the bottom. 
