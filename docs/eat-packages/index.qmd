...
|------------|------------|------------|------------|------------|------------|
|**eatPrep**    | test               | test             | test   | test                  | test          |
|**eatModel**   | test              | test             | test   | test                  | test          |
|**eatRep**     | test               | test             | test   | test                  | test          |
|**eatGADS**    | test               | test             | test   | test                  | test          |
|**eatTools**   | test              | test             | test   | test                  | test          |
|**eatAnalysis**| test           | test             | test   | test                  | test          |
|**eatATA**     | test               | test             | test   | test                  | test          |
|**eatFDZ**     | test               | test             | test   | test                  | test          |
|**eatCodebook**| test           | test             | test   | test                  | test          |
|**eatRecode**  | test             | test             | test   | test                  | test          |
|**eatPlot**    | test               | test             | test   | test                  | test          |




Pakete: eatPrep, eatModel, eatRep, earGADS, eatTools, eatAnalysis, eatATA, eatFDZ, eatCodebook, eatRecode, eatPlot
