...
Paketname <- c("eatPrep", "eatModel", "eatRep", "eatGADS", "eatTools", 
               ...
               "eatPlot")
Beschreibung <- c(descFunktion_prep, descFunktion_model, descFunktion_rep, descFunktion_gads, descFunktion_tools, 
                  descFunktion_anal, descFunktion_ata, descFunktion_fdz, descFunktion_codebook, descFunktion_recode, descFunktion_plot)
#desc <- substring(Beschreibung, 1, 100)
...
#an[3] <- paste(p[5], "," ,p[1])
#an[c(4, 7:9)] <- p[1]
#an[5] <- paste(p[5], "," ,p[1], ",", p[4])
#an[6] <- paste(p[1], "," ,p[5], ",", p[4])
#an[10] <- paste(p[1], "," ,p[3])
#an[11] <- paste(p[3], "," ,p[2])

links <- ""
links[1] <- "test"#"[eatPrep](eatPrep.qmd)"
...
df <- data.frame(Paketname, Beschreibung, links)


# find out how to print nicer
df_layout <- df
colnames(df_layout) <- c("Paketname", "Funktionsbeschreibung", "mehr Infos zum Paket")
