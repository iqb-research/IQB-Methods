...
2) The internal structure of the package is documented [here](https://github.com/iqb-research/IQB-Methods/blob/main/_site/structure.html). This overview is primarily dedicated to developers who want to want to further improve or extend the package and therefore need to understand its structure. 
3) Workshop materials concerning `eatRep` can be found on the IQB network drives: `i:\Methoden\02_IQB-interne_eat_Workshops\eatRep_2021\`
