...
doku_rep <- c("internal", "internal", "[Replication Analysis with eatRep](https://cran.r-project.org/web//packages/eatRep/vignettes/eatRep.html)", "[Internal Structure of eatRep](https://github.com/iqb-research/IQB-Methods/blob/main/_site/structure.html)")
